...
<head>
    ...
    <title>Gateway API By Adiyatan</title>
    <!--Style-->
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div class="card">
        ...
        <br>
        <pre>
        A    DDDD  III  Y   Y    A   TTTTT    A     N   N
       A A   D   D  I    Y Y    A A    T     A A    NN  N
      AAAAA  D   D  I     Y    AAAAA   T    AAAAA   N N N
     A     A DDDD  III    Y   A     A  T   A     A  N  NN
    </pre>
        <p>at your service</p>
    </div>
    <!--Matrix-->
        ...
        var VanillaTilt = (function () {
            ...
            class t {
                ...
                extendSettings(t) {
                    ...
                    for (var s in e) if (s in t) i[s] = t[s]; else if (this.element.hasAttribute("data-tilt-" + s)) { let t = this.element.getAttribute("data-tilt-" + s); try { i[s] = JSON.parse(t) } catch (e) { i[s] = t } } else i[s] = e[s];
                    return i;
                }
                static init(e, i) {
